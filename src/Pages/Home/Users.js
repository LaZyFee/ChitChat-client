...
const Users = ({ selectedUser, setSelectedUser, setShowChatOnMobile }) => {
            ...
            <ul className="list-none p-0 m-0">
                {users.map((user) => {
                    ...
                    return (
                        <li
                            key={user._id}
                            className={`flex items-center space-x-4 p-2 cursor-pointer hover:bg-gray-700 rounded-md`}
                            onClick={() => {
                        ...
                        >
                            <img
                                src={user.profilePicture?.data
                                    ...
                                    : '/default-avatar.png'}
                                alt="avatar"
                                className="w-12 h-12 rounded-full" // Adjusted width and height
                            />
                            <div className="flex-1">
                                ...
                                <p className="text-xs text-blue-500 text-end me-3">
